...
public class PersonFormView extends Div {
    ...
    public PersonFormView(SamplePersonService personService) {
        ...
        //anchorNav.setSizeFull();
        anchorNav.setHeight("600px");       
		anchorNav.addSection("1",vl);
        Span span2 = new Span("Section 2");
		anchorNav.addSection("2",span2);
		
		vl.add(createTitle(), createFormLayout(), createButtonLayout());
